            ...
            <center>
                ...
                <div class="main_block">
                    ...
                    <div class="main_login_detail">
                        ...
                        <div class="login_email"><input type="input" class="login_email_search" placeholder="E-mail" autocomplete="off"></div>

                        <div class="login_password"><input type="password" class="login_password_search" placeholder="密碼" autocomplete="off"></div>
                        ...
                        <div class="login_button">登入</div>

                        

                        <div class="register_button">註冊新帳號並登入</div>
