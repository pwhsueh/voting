                    ...
                    <div class="main_720">
                    	...
                    	<div class="edit_block">
                            ...
                            <div class="edit_content">
                            	...
                            	<input type="text"   name="sort_order" value="<?php echo $event->sort_order ?>">
                            </div>
                        ...
                        <div class="edit_block">
                            ...
                            <div class="edit_content">
                                ...
                                <div class="edit_checkbox"><input name="allow_email" value="1" type="checkbox" id="checkbox-1-1" class="regular-checkbox" <?php if ($event->allow_email == 1): ?>
                                	checked
                                <?php endif ?> /><label for="checkbox-1-1"></label></div>

                                <div class="edit_check_text">允許前端使用者，透過E-Mail登入</div><br>

                                <div class="edit_checkbox"><input name="allow_fb" value="1" type="checkbox" id="checkbox-1-2" class="regular-checkbox"  <?php if ($event->allow_fb == 1): ?>
                                	checked
                                <?php endif ?> /><label for="checkbox-1-2"></label></div>
                        ...
                        <div class="edit_block">
                            ...
                            <div class="edit_content">
                                ...
                                <div class="edit_checkbox"><input name="can_vote" value="1"  type="checkbox" id="checkbox-2-1" class="regular-checkbox"  <?php if ($event->allow_fb == 1): ?>
                                	checked
                                <?php endif ?>/><label for="checkbox-2-1"></label></div>
                                ...
                                <div class="edit_checkbox"><input type="checkbox" value="1" name="can_like" id="checkbox-2-2" class="regular-checkbox"  <?php if ($event->can_like == 1): ?>
                                	checked
                                <?php endif ?>/><label for="checkbox-2-2"></label></div>

                                <div class="edit_check_text">按讚</div><br>

                                <div class="edit_checkbox"><input type="checkbox" value="1" name="can_share" id="checkbox-2-3" class="regular-checkbox"  <?php if ($event->can_share == 1): ?>
                                	checked
                                <?php endif ?>/><label for="checkbox-2-3"></label></div>
                        ...
                        <?php if (isset($event->photo) && "" != $event->photo): ?>
                        <div class="edit_block"> 
                            <img style="max-height:350px" src="<?php echo site_url()."assets/".$event->photo; ?>" />            
                        </div>
                        <?php endif ?>
                       ...
                       <?php if (isset($event->spilt_file) && "" != $event->spilt_file): ?>
                        <div class="edit_block"> 
